...
public class mxSwingConstants
{
	...
	static
	{
		try
		{
			mxSwingConstants.SHADOW_COLOR = new Color(0,0,0,0);
			mxSwingConstants.DEFAULT_VALID_COLOR = new Color(255,255,255,0);
			...
			mxSwingConstants.HANDLE_FILLCOLOR = new Color(255,255,255,0);
			mxSwingConstants.LABEL_HANDLE_FILLCOLOR = Color.yellow;
			mxSwingConstants.LOCKED_HANDLE_FILLCOLOR = Color.red;
			mxSwingConstants.CONNECT_HANDLE_FILLCOLOR = new Color(255,255,255,0);
			mxSwingConstants.EDGE_SELECTION_COLOR = new Color(255,255,255,0);
			mxSwingConstants.VERTEX_SELECTION_COLOR = new Color(255,255,255,0);
		}
		catch (Exception e)
		{
